...
console.log(addExclamation(['r','a','d']));
/* ------------------------------------------------------------------------------------------------
CHALLENGE 3
...
const allUpperCase = (arr) => {
  let uperCaseArray = [];
  arr.forEach(element => {
    uperCaseArray.push(element.toUpperCase())
  });
  return uperCaseArray;
};
console.log(allUpperCase(['rawnaq','Raed']));
/* ------------------------------------------------------------------------------------------------
CHALLENGE 4
...
const speaker = (words, callback) => {
  ...
  words.forEach(element => {
    wordArray.push(greeting(element));
  });
  return wordArray;
};
console.log(speaker (['rawn','rrr','ggg']))
...
console.log(addNumbers (4, [2,4,5], 3));
...
const createList = (availableItems) => {
  // Solution code here...
  let inventoryArr=[];
  availableItems.forEach(theItem=>{
    if(theItem.available){
      inventoryArr.push(theItem.name)
    }   
  })
  return inventoryArr;
