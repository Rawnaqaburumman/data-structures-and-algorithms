...
const toLastNames = people => {
  // Solution code here...
  let fullNames = people.map(function (i) {
...
const addPurchases = (arr) => {
  ...
  // Solution code here...
  let sum = arr.reduce((accu, newv) => {
    accu += newv.purchasePrice;
    return accu;
  }, 0);
  return sum;
...
const countNumberOfElements = (arr) => {
  ...
  let numberOfElements = arr.reduce((accu) => {
    accu += 1;
    return accu;
  }, 0);
...
const returnNames = (arr) => {
   // Solution code here...
   let newArr = [];
   arr.reduce((a, b) =>  newArr.push(b.name),0 );
   return newArr;
 };
...
const reversedString = (str) => {
  // Solution code here...
   // Solution code here...
   let arr = str.split('');
   let newArray=arr.reduce((a,b)=>b+a,'');
   return newArray ;
 };
